...
- (void)addUI
{
    ...
    //头部
    UIImage *headImage = [UIImage imageNamed:@"child_head_front"];
    ...
    //颈部
    UIImage *neckImage = [UIImage imageNamed:@"child_neck_front"];
    ...
    //胸部
    UIImage *chestImage = [UIImage imageNamed:@"child_chest_front"];
    ...
    //肚子
    UIImage *tripeImage = [UIImage imageNamed:@"child_tripe_front"];
    ...
    //生殖部位
    UIImage *engImage = [UIImage imageNamed:@"child_engenderpart_front"];
    ...
    //腿
    UIImage *legImage = [UIImage imageNamed:@"child_leg_front"];
    ...
    //脚
    UIImage *footImage = [UIImage imageNamed:@"child_foot_front"];
    ...
    //左臂
    UIImage *leftArmImage = [UIImage imageNamed:@"child_leftArm_front"];
    ...
    //右臂
    UIImage *rightArmImage = [UIImage imageNamed:@"child_rightArm_front"];
    ...
    //右手
    UIImage *righthandImage = [UIImage imageNamed:@"child_righthand_front"];
    ...
    [headBtn addTarget:self action:@selector(childFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    headBtn.tag = 1;
    [neckBtn addTarget:self action:@selector(childFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    neckBtn.tag = 2;
    [chestBtn addTarget:self action:@selector(childFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    chestBtn.tag = 3;
    [tripeBtn addTarget:self action:@selector(childFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    tripeBtn.tag = 4;
    [engBtn addTarget:self action:@selector(childFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    engBtn.tag = 5;
    [legBtn addTarget:self action:@selector(childFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    legBtn.tag = 6;
    [footBtn addTarget:self action:@selector(childFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    footBtn.tag = 7;
    [leftArmBtn addTarget:self action:@selector(childFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    leftArmBtn.tag = 8;
    [lefthandBtn addTarget:self action:@selector(childFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    lefthandBtn.tag = 9;
    [rightArmBtn addTarget:self action:@selector(childFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    rightArmBtn.tag = 10;
    [righthandBtn addTarget:self action:@selector(childFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    righthandBtn.tag = 11;

}
- (void)childFrontClickAction:(UIButton *)sender
{
    NSInteger idx = sender.tag;
    if (self.delegate && [self.delegate respondsToSelector:@selector(selectSex:selectPart:isFront:)]) {
        [self.delegate selectSex:3 selectPart:idx isFront:YES];
    }
}
