...
- (void)addUI
{
    ...
    //头部
    UIImage *headImage = [UIImage imageNamed:@"child_head_back"];
    ...
    //颈部
    UIImage *neckImage = [UIImage imageNamed:@"child_neck_back"];
    ...
    //胸部
    UIImage *chestImage = [UIImage imageNamed:@"child_chest_back"];
    ...
    //肚子
    UIImage *tripeImage = [UIImage imageNamed:@"child_chtrip_back"];
    ...
    //生殖部位
    UIImage *engImage = [UIImage imageNamed:@"child_hip_back"];
    ...
    //腿
    UIImage *legImage = [UIImage imageNamed:@"child_leg_back"];
    ...
    //脚
    UIImage *footImage = [UIImage imageNamed:@"child_foot_back"];
    ...
    //左臂
    UIImage *leftArmImage = [UIImage imageNamed:@"child_leftArm_back"];
    ...
    //右臂
    UIImage *rightArmImage = [UIImage imageNamed:@"child_rightArm"];
    ...
    //右手
    UIImage *righthandImage = [UIImage imageNamed:@"child_righHand_back"];
    ...
    [headBtn addTarget:self action:@selector(childBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    headBtn.tag = 1;
    [neckBtn addTarget:self action:@selector(childBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    neckBtn.tag = 2;
    [chestBtn addTarget:self action:@selector(childBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    chestBtn.tag = 3;
    [tripeBtn addTarget:self action:@selector(childBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    tripeBtn.tag = 4;
    [engBtn addTarget:self action:@selector(childBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    engBtn.tag = 5;
    [legBtn addTarget:self action:@selector(childBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    legBtn.tag = 6;
    [footBtn addTarget:self action:@selector(childBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    footBtn.tag = 7;
    [leftArmBtn addTarget:self action:@selector(childBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    leftArmBtn.tag = 8;
    [lefthandBtn addTarget:self action:@selector(childBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    lefthandBtn.tag = 9;
    [rightArmBtn addTarget:self action:@selector(childBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    rightArmBtn.tag = 10;
