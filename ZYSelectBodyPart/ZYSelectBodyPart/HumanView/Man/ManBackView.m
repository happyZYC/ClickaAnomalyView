...
- (void)addUI
{
    ...
    //头部
    UIImage *headImage = [UIImage imageNamed:@"man_head_back"];
    ...
    //颈部
    UIImage *neckImage = [UIImage imageNamed:@"man_neck_back"];
    ...
    //胸部
    UIImage *chestImage = [UIImage imageNamed:@"man_chest_back"];
    ...
    //肚子
    UIImage *tripeImage = [UIImage imageNamed:@"man_tripe_back"];
    ...
    //生殖部位
    UIImage *engImage = [UIImage imageNamed:@"man_hip_back"];
    ...
    //腿
    UIImage *legImage = [UIImage imageNamed:@"man_leg_back"];
    ...
    //左臂
    UIImage *leftArmImage = [UIImage imageNamed:@"man_leftArm_back"];
    ...
    //左手
    UIImage *lefthandImage = [UIImage imageNamed:@"man_lefthand_back"];
    ...
    //右臂
    UIImage *rightArmImage = [UIImage imageNamed:@"man_rightArm_back"];
    ...
    //右手
    UIImage *righthandImage = [UIImage imageNamed:@"man_righthand_back"];
    ...
    [headBtn addTarget:self action:@selector(manBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    headBtn.tag = 1;
    [neckBtn addTarget:self action:@selector(manBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    neckBtn.tag = 2;
    [chestBtn addTarget:self action:@selector(manBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    chestBtn.tag = 3;
    [tripeBtn addTarget:self action:@selector(manBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    tripeBtn.tag = 4;
    [engBtn addTarget:self action:@selector(manBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    engBtn.tag = 5;
    [legBtn addTarget:self action:@selector(manBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    legBtn.tag = 6;
    [footBtn addTarget:self action:@selector(manBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    footBtn.tag = 7;
    [leftArmBtn addTarget:self action:@selector(manBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    leftArmBtn.tag = 8;
    [lefthandBtn addTarget:self action:@selector(manBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    lefthandBtn.tag = 9;
    [rightArmBtn addTarget:self action:@selector(manBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    rightArmBtn.tag = 10;
    [righthandBtn addTarget:self action:@selector(manBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    [righthandBtn addTarget:self action:@selector(manBackClickAction:) forControlEvents:UIControlEventTouchUpInside];
    righthandBtn.tag = 11;

}
- (void)manBackClickAction:(UIButton *)sender
{
    NSInteger idx = sender.tag;
    if (self.delegate && [self.delegate respondsToSelector:@selector(selectSex:selectPart:isFront:)]) {
        [self.delegate selectSex:1 selectPart:idx isFront:NO];
    }
}
