...
- (void)addUI
{
    ...
    //头部
    UIImage *headImage = [UIImage imageNamed:@"woman_head_front"];
    ...
    //颈部
    UIImage *neckImage = [UIImage imageNamed:@"woman_neck_front"];
    ...
    //胸部
    UIImage *chestImage = [UIImage imageNamed:@"woman_chest_front"];
    ...
    //肚子
    UIImage *tripeImage = [UIImage imageNamed:@"woman_tripe_front"];
    ...
    //生殖部位
    UIImage *engImage = [UIImage imageNamed:@"woman_eng_front"];
    ...
    //腿
    UIImage *legImage = [UIImage imageNamed:@"woman_leg_front"];
    ...
    //脚
    UIImage *footImage = [UIImage imageNamed:@"woman_foot_front"];
    ...
    //左臂
    UIImage *leftArmImage = [UIImage imageNamed:@"woman_leftArm_front"];
    ...
    //左手
    UIImage *lefthandImage = [UIImage imageNamed:@"woman_lefthand_front"];
    ...
    //右臂
    UIImage *rightArmImage = [UIImage imageNamed:@"woman_rightArm_front"];
    ...
    //右手
    UIImage *righthandImage = [UIImage imageNamed:@"woman_righthand_front"];
    ...
    [headBtn addTarget:self action:@selector(womanFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    headBtn.tag = 1;
    [neckBtn addTarget:self action:@selector(womanFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    neckBtn.tag = 2;
    [chestBtn addTarget:self action:@selector(womanFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    chestBtn.tag = 3;
    [tripeBtn addTarget:self action:@selector(womanFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    tripeBtn.tag = 4;
    [engBtn addTarget:self action:@selector(womanFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    engBtn.tag = 5;
    [legBtn addTarget:self action:@selector(womanFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    legBtn.tag = 6;
    [footBtn addTarget:self action:@selector(womanFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    footBtn.tag = 7;
    [leftArmBtn addTarget:self action:@selector(womanFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    leftArmBtn.tag = 8;
    [lefthandBtn addTarget:self action:@selector(womanFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    lefthandBtn.tag = 9;
    [rightArmBtn addTarget:self action:@selector(womanFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    rightArmBtn.tag = 10;
    [righthandBtn addTarget:self action:@selector(womanFrontClickAction:) forControlEvents:UIControlEventTouchUpInside];
    righthandBtn.tag = 11;
}
- (void)womanFrontClickAction:(UIButton *)sender
{
    NSInteger idx = sender.tag;
    if (self.delegate && [self.delegate respondsToSelector:@selector(selectSex:selectPart:isFront:)]) {
        [self.delegate selectSex:2 selectPart:idx isFront:YES];
    }
}
